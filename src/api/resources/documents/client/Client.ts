...
export class Documents {
     ...
     * @param {Vectara.DocumentsListCorpusRequest} request
     ...
     *
     * @param {Vectara.CorpusKey} corpusKey - The unique key identifying the queried corpus.
     * @param {Vectara.CreateDocumentRequest} request
     * @param {Documents.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    public async create(
        ...
        const _response = await (this._options.fetcher ?? core.fetcher)({
            ...
            contentType: "application/json",
            requestType: "json",
            body: serializers.CreateDocumentRequest.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }),
            timeoutMs: requestOptions?.timeoutInSeconds != null ? requestOptions.timeoutInSeconds * 1000 : 60000,
            maxRetries: requestOptions?.maxRetries,
            abortSignal: requestOptions?.abortSignal,
        });
