...
export declare namespace LargeLanguageModels {
    interface Options {
 ...
 */
export class LargeLanguageModels {
    constructor(protected readonly _options: LargeLanguageModels.Options = {}) {}

    /**
     * List LLMs that can be used with query and chat endpoints.
     *
     * @param {Vectara.LargeLanguageModelsListRequest} request
     * @param {LargeLanguageModels.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): Promise<Vectara.ListLlMsResponse> {
